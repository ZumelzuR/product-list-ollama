...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.post('/api/v1/auth/token',
            ...
            const args = {
                    loginBody: {"in":"body","name":"loginBody","required":true,"ref":"LoginBody"},
            };
        ...
        app.post('/api/v1/auth/register',
            ...(fetchMiddlewares<RequestHandler>(AuthController)),
            ...(fetchMiddlewares<RequestHandler>(AuthController.prototype.addUser)),

            function AuthController_addUser(request: any, response: any, next: any) {
            const args = {
                    resgisterBody: {"in":"body","name":"resgisterBody","required":true,"dataType":"any"},
            };
        ...
        app.post('/api/v1/products',
            ...
            const args = {
                    productBody: {"in":"body","name":"productBody","required":true,"ref":"ProductCreateDto"},
            };
        ...
        app.put('/api/v1/products/:id',
            ...
            const args = {
                    id: {"in":"path","name":"id","required":true,"dataType":"string"},
                    update: {"in":"body","name":"update","required":true,"ref":"ProductUpdateDto"},
            };
