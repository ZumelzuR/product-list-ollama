class HttpReason {
  ...
  public static readonly NOT_FOUND_CUSTOM__MESSAGE = '404 Not Found ¯_(ツ)_/¯';
  public static readonly ROLE_UNAUTHORIZED: string =
    'Unauthorized resource permission';
  public static readonly SESSION_EXPIRED: string =
    'Unauthorized session expired';
  public static readonly SUBSCRIPTION_INACTIVE: string =
    'Active Subscription Required';
  public static readonly WAREHOUSE_NOT_LINKED =
    'Warehouse not linked to any company';
}
